...
public class BarcaItemTouchHelperCallback extends
        ItemTouchHelper.Callback {

    private BarcaTouchHelperAdapter todoTouchHelperAdapter;

    public BarcaItemTouchHelperCallback(BarcaTouchHelperAdapter todoTouchHelperAdapter) {
